...
### Khưu Minh Toàn - Mã HV: 2A202601011
* **Vai trò:** Backend Developer & System Integrator (Nhóm Trưởng)
...
### Nguyễn Bùi Tấn Dũng - Mã HV: 2A202600546
...
### Đoàn Xuân Thạch - Mã HV: 2A202600950
* **Vai trò:** Data Specialist & Evaluator 1 (Thiết kế Bộ Đánh Giá)
...
### Phan Tân Hưng - Mã HV: 2A202600825
* **Vai trò:** Evaluator 2 & Analyst (Chạy Eval & Viết Báo Cáo)
...
| **Giai đoạn 2: Phát triển song song** | - Khưu Minh Toàn: Tích hợp RAG Pipeline & Database.<br>- Nguyễn Bùi Tấn Dũng: Dựng khung UI Chatbot.<br>- Đoàn Xuân Thạch: Soạn Golden Dataset (15+ Q&A). | Khưu Minh Toàn, Nguyễn Bùi Tấn Dũng, Đoàn Xuân Thạch | Ngày 2-3 |
| **Giai đoạn 3: Kết nối & Eval** | - Khưu Minh Toàn & Nguyễn Bùi Tấn Dũng: Kết nối UI với RAG Pipeline.<br>- Đoàn Xuân Thạch & Phan Tân Hưng: Viết script `eval_pipeline.py` và chạy thử nghiệm. | Cả nhóm | Ngày 4 |
| **Giai đoạn 4: So sánh & Báo cáo** | Chạy đánh giá A/B, thu thập kết quả, viết báo cáo `results.md` và tinh chỉnh chatbot. | Phan Tân Hưng (chính) & Khưu Minh Toàn | Ngày 5 |
...
3. Đóng gói các hàm tìm kiếm và sinh văn bản thành một Class hoặc tập hợp các function chuẩn hóa:
   ...
   class GroupRAGPipeline:
       ...
       def generate(self, query: str, conversation_history: list = None) -> dict:
           ...
           pass
   ```
4. Khưu Minh Toàn hỗ trợ Nguyễn Bùi Tấn Dũng và Phan Tân Hưng kết nối class này để phục vụ UI chatbot và đánh giá.
